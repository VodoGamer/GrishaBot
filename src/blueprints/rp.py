...
async def to_kick(message: Message, match, user: User):
    await Rp(
        message, "ударил", match[-1], user, "photo-194020282_457239111"
    ).send_message()
...
async def poooooo(message: Message, match, user: User):
    await Rp(
        message, "обдристал", match[-1], user, "photo-194020282_457239089"
    ).send_message()
...
async def fuck(message: Message, match, user: User):
    await Rp(
        message, "выебал", match[-1], user, "photo-194020282_457239085"
    ).send_message()
...
async def to_fuck_off(message: Message, match, user: User):
    await Rp(
        message, "уебал", match[-1], user, "photo-194020282_457239112"
    ).send_message()
...
async def cum(message: Message, match, user: User):
    await Rp(
        message, "обкончал", match[-1], user, "photo-194020282_457239090"
    ).send_message()
...
async def suck_it(message: Message, match, user: User):
    await Rp(
        message, "отсосал у", match[-1], user, "photo-194020282_457239097"
    ).send_message()
...
async def hug(message: Message, match, user: User):
    await Rp(
        message, "обнял", match[-1], user, "photo-194020282_457239092"
    ).send_message()
...
async def suck(message: Message, match, user: User):
    await Rp(
        message, "засосал", match[-1], user, "photo-194020282_457239086"
    ).send_message()
...
async def fart(message: Message, match, user: User):
    await Rp(
        message, "пёрнул на", match[-1], user, "photo-194020282_457239098"
    ).send_message()
...
async def fuck_strong(message: Message, match, user: User):
    await Rp(
        message, "обтрахал", match[-1], user, "photo-194020282_457239094"
    ).send_message()
...
async def kill(message: Message, match, user: User):
    await Rp(
        message, "убил", match[-1], user, "photo-194020282_457239110"
    ).send_message()
...
async def fuck_off(message: Message, match, user: User):
    await Rp(
        message, "послал", match[-1], user, "photo-194020282_457239104"
    ).send_message()
...
async def slap(message: Message, match, user: User):
    await Rp(
        message, "шлёпнул", match[-1], user, "photo-194020282_457239113"
    ).send_message()
...
async def kick(message: Message, match, user: User):
    await Rp(
        message, "пнул", match[-1], user, "photo-194020282_457239100"
    ).send_message()
...
async def burn(message: Message, match, user: User):
    await Rp(
        message, "сжёг", match[-1], user, "photo-194020282_457239107"
    ).send_message()
...
async def smell_it(message: Message, match, user: User):
    await Rp(
        message, "понюхал", match[-1], user, "photo-194020282_457239103"
    ).send_message()
...
async def lick(message: Message, match, user: User):
    await Rp(
        message, "облизал", match[-1], user, "photo-194020282_457239091"
    ).send_message()
...
async def stroke(message: Message, match, user: User):
    await Rp(
        message, "погладил", match[-1], user, "photo-194020282_457239101"
    ).send_message()
...
async def piss_on(message: Message, match, user: User):
    await Rp(
        message, "обоссал", match[-1], user, "photo-194020282_457239093"
    ).send_message()
...
async def spit(message: Message, match, user: User):
    await Rp(
        message, "плюнул в", match[-1], user, "photo-194020282_457239099"
    ).send_message()
...
async def touch(message: Message, match, user: User):
    await Rp(
        message, "потрогал", match[-1], user, "photo-194020282_457239105"
    ).send_message()
...
async def give_a_shit(message: Message, match, user: User):
    await Rp(
        message, "насрал", match[-1], user, "photo-194020282_457239088"
    ).send_message()
...
async def paw(message: Message, match, user: User):
    await Rp(
        message, "полапал", match[-1], user, "photo-194020282_457239102"
    ).send_message()
...
async def eat(message: Message, match, user: User):
    await Rp(
        message, "съел", match[-1], user, "photo-194020282_457239108"
    ).send_message()
...
async def take_a_bite(message: Message, match, user: User):
    await Rp(
        message, "откусил", match[-1], user, "photo-194020282_457239095"
    ).send_message()
...
async def bite(message: Message, match, user: User):
    await Rp(
        message, "укусил", match[-1], user, "photo-194020282_457239115"
    ).send_message()
...
async def kiss(message: Message, match, user: User):
    await Rp(
        message, "поцеловал", match[-1], user, "photo-194020282_457239106"
    ).send_message()
...
async def attack(message: Message, match, user: User):
    await Rp(
        message, "напал на", match[-1], user, "photo-194020282_457239116"
    ).send_message()
...
async def cut(message: Message, match, user: User):
    await Rp(
        message, "разрезал", match[-1], user, "photo-194020282_457239119"
    ).send_message()
...
async def shoot(message: Message, match, user: User):
    await Rp(
        message, "расстрелял", match[-1], user, "photo-194020282_457239120"
    ).send_message()
...
async def pomat(message: Message, match, user: User):
    await Rp(
        message, "помацал", match[-1], user, "photo-194020282_457239118"
    ).send_message()
...
async def fuck_up(message: Message, match, user: User):
    await Rp(
        message, "захуярил", match[-1], user, "photo-194020282_457239117"
    ).send_message()
